        ...
        @forelse ($thps1plus2Results as $key => $thps1plus2)
            ...
            >
                ...
                >
                    ...
                    >
                        <a class="relative bottom-4" href="videos/thps1plus2/{{ $key }}">
                            <svg
                                fill="currentColor"
                        ...
                        <p class="text-sm font-semibold ml-14">
                            {{ Illuminate\Support\Str::limit($thps1plus2['Title'], 40) }}
                        </p>
                    </div>
            </div>
        @empty
